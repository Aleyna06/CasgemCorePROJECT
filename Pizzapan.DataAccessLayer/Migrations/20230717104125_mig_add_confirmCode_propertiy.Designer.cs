...
namespace Pizzapan.DataAccessLayer.Migrations
{
    ...
    [Migration("20230717104125_mig_add_confirmCode_propertiy")]
    partial class mig_add_confirmCode_propertiy
    {
            ...
            modelBuilder.Entity("Pizzapan.EntityLayer.Concrete.Discount", b =>
                {
                    ...
                    b.Property<string>("DiscountCupon")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Discountcount")
                        .HasColumnType("int");

                    b.Property<DateTime>("EndlingDate")
                        .HasColumnType("datetime2");
